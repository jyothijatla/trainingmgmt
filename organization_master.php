...
<html>
  ...
  <body>
    <div class="testbox">
      <form action="orgdata.php" method = "POST">
        <div class="banner">
        ...
        <div class="item">
          ...
          <div class="name-item">
            <input type="text" name="orgname" placeholder="First"/>
          </div> 
        <div class="item">
          <p>Year of establishment</p>
          <input type="text" name="yearofestablishment"/>
        </div>
        <div class="item">
          <p>No of branches</p>
          <input type="text" name="noofbranches"/>
        </div>
        <div class="item">
          <p>Registration ID</p>
          <input type="int" name="registration_id"/>
        </div>
        <div class="item">
          <p>Address</p>
