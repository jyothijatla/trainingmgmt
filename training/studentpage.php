   ...
   <body class="main-layout home_page">
      ...
      <header>
        ...
        <div class="dropdown-menu" aria-labelledby="Student">
          <a class="dropdown-item" href="studentform.php">Add Student</a>
           <div class="dropdown-divider"></div>
          <a class="dropdown-item" href="studentview.php">View Student</a>
          <div class="dropdown-divider"></div>
        </div>
      </li>
         ...
         <div class="container">
            <div class="row">
               <div class="col-md-10 offset-md-1">
                  <div class="aboutheading">
                     ...
                     <span>Our Students are the Top most with great knowledge on the subject & they were place in top MNCs Companies.</span>
                  </div>
               </div>
            </div>
            <div class="row border">
               <div class="col-xl-7 col-lg-7 col-md-12 col-sm-12">
                  <div class="about-box">
                     <p> Our students are imperative that the duties and responsibilities with great knowledge<br>
               ...
               <div class="col-xl-5 col-lg-5 col-md-12 col-sm-12">
                  <div class="about-box">
                     <figure><img src="images/students.jpg" alt="" /></figure>
                  </div>
               </div>
            </div>
         </div>
