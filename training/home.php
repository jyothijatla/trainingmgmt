...
<html lang="en">
   <head>
      ...
      <!-- site metas -->
      <title>Rashis' Training Institute</title>
      ...
      <header>
        ...
        <div class="dropdown-menu" aria-labelledby="Courses">
          <a class="dropdown-item" href="php.php">Php</a>
           <div class="dropdown-divider"></div>
          <a class="dropdown-item" href="salesforce.php">Salesforce</a>
          <div class="dropdown-divider"></div>
          <a class="dropdown-item" href="sharepoint.php">SharePoint</a>
          <div class="dropdown-divider"></div>
          <a class="dropdown-item" href="java.php">Java</a>
          <div class="dropdown-divider"></div>
          <a class="dropdown-item" href="fsd.php">Full Stack Development</a>
        </div>
      </li>
         ...
         <div id="myCarousel" class="carousel slide banner-main" data-ride="carousel">
            <div class="carousel-inner">
               ...
               <div class="carousel-item">
                  ...
                  <div class="container">
                     <div class="carousel-caption relative">
                        <h1>The Best Faculty That<br> Every institute Must have!</h1>
               ...
               <div class="carousel-item">
                  ...
                  <div class="container">
                     <div class="carousel-caption relative">
                        <h1>The Best Branches <br> all over the country</h1>
         ...
         <div class="container">
            <div class="row">
               <div class="col-md-10 offset-md-1">
                  <div class="aboutheading">
                     ...
                     <span>The Best Place to Learn PHP,Salesforce,SharePoint,Java & Full Stack Developer</span>
                  </div>
               </div>
            </div>
            <div class="row border">
               <div class="col-xl-7 col-lg-7 col-md-12 col-sm-12">
                  <div class="about-box">
                     <p> Rashis Training Institute is the best place to learn all the Softwares like HTML,CSS,JavaScript,PHP & MySQL.<br>
                             It helps for your career growth & development.Our Faculty helps to teach the best <br> of our all the softwares.<br> Like PHP,Salesforce,SQL</p>
                     <a href="#">Read More</a>
                  </div>
               </div>
               <div class="col-xl-5 col-lg-5 col-md-12 col-sm-12">
                  <div class="about-box">
                     <figure><img src="images/php.jpg" alt="" /></figure>
                  </div>
               </div>
            </div>
         </div>
