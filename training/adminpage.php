...
<html lang="en">
   ...
   <body class="main-layout home_page">
      ...
      <header>
        ...
        <div class="dropdown-menu" aria-labelledby="Admin">
          ...
          <a class="dropdown-item" href="adminview.php">Admin View</a>
          <div class="dropdown-divider"></div>
        </div>
      </li>
  ...
  <h2 class="w3-wide"><b>WELCOME ADMIN<b></h2>
         ...
         <div class="container">
            <div class="row">
               <div class="col-md-10 offset-md-1">
                  <div class="aboutheading">
                     ...
                     <span>Our Admin Department handles all the oppurtunities & queries with great responsibility</span>
                  </div>
               </div>
            </div>
            <div class="row border">
               <div class="col-xl-7 col-lg-7 col-md-12 col-sm-12">
                  <div class="about-box">
                     <p> Our admin dept is imperative that the duties and responsibilities of the management and the administrator<br>
