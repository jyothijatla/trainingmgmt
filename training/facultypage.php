   ...
   <body class="main-layout home_page">
      ...
      <header>
        ...
        <div class="dropdown-menu" aria-labelledby="Faculty">
          ...
          <a class="dropdown-item" href="facultyview.php">Faculty View</a>
          <div class="dropdown-divider"></div>
        </div>
      </li>
         ...
         <div class="container">
            <div class="row">
               <div class="col-md-10 offset-md-1">
                  <div class="aboutheading">
                     ...
                     <span>Our Faculty are the Top most with great knowledge on the subject.</span>
                  </div>
               </div>
            </div>
            <div class="row border">
               ...
               <div class="col-xl-5 col-lg-5 col-md-12 col-sm-12">
                  <div class="about-box">
                     <figure><img src="images/faculty.jpg" alt="" /></figure>
                  </div>
               </div>
            </div>
         </div>
