   ...
   <body class="main-layout home_page">
      ...
      <header>
        ...
        <div class="dropdown-menu" aria-labelledby="Admin">
          <a class="dropdown-item" href="adminform.php">Add Admin</a>
      ...
      <li class="nav-item dropdown">
        ...
        <div class="dropdown-menu" aria-labelledby="Faculty">
          <a class="dropdown-item" href="facultyform.php">Add Faculty</a>
           <div class="dropdown-divider"></div>
          <a class="dropdown-item" href="facultyview.php">View Faculty</a>
          <div class="dropdown-divider"></div>
        </div>
      </li>
      <li class="nav-item dropdown">
        ...
        <div class="dropdown-menu" aria-labelledby="Students">
          <a class="dropdown-item" href="studentsform.php">Add Students</a>
           <div class="dropdown-divider"></div>
          <a class="dropdown-item" href="studentsview.php">View Students</a>
          <div class="dropdown-divider"></div>
        </div>
      </li>
         ...
         <div class="container">
            <div class="row">
               <div class="col-md-10 offset-md-1">
                  <div class="aboutheading">
                     ...
                     <span>Our Department handles all the Staff,Students,Admin & Staff very well with responsibility</span>
                  </div>
               </div>
            </div>
            <div class="row border">
               <div class="col-xl-7 col-lg-7 col-md-12 col-sm-12">
                  <div class="about-box">
                     <p> Our dept is imperative that the duties and responsibilities of the management and the administrator<br>
               ...
               <div class="col-xl-5 col-lg-5 col-md-12 col-sm-12">
                  <div class="about-box">
                     <figure><img src="images/super.jpg" alt="" /></figure>
                  </div>
               </div>
            </div>
         </div>
