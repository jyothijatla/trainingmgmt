...
<html>
        ...
        <body>
            ...
            <h1 style=text-align:center><b>Student Dashboard<b></h1>
        ...
        <br><a href="studentpage.php">Connect to StudentPage</a>
  ...
  <div>
    <canvas id="myChart"></canvas>
            ...
            type: 'pie',
            data: {
            labels: ["branches", "courses", "students", "others"],
            datasets: [{
            backgroundColor: [
            "#2ecc71",
            "#3498db",
